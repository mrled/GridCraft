...
dist/GridCraft.spoon: $(LUASRCS) dist/GridCraft.spoon/phosphor/assets/.installed ## Build the Spoon package
...
site/data/docs.json: dist/GridCraft.spoon ## Generate documentation JSON
	mkdir -p site/data
	/Applications/Hammerspoon.app/Contents/Frameworks/hs/hs -c \
		"hs.doc.builder.genJSON(\"$(CURDIR)/dist/GridCraft.spoon\")" > dist/docsoutput.txt
...
dist/docs/.generated: $(LUASRCS) site/data/docs.json .venv/bin/activate
	mkdir -p dist/docs
